...
//endpoint akses data user berdasarkan id_pelanggaran tertentu
app.get("/:id", (req, res) => {
    let data = {
...
//endpoint mengubah data pelanggaran
app.put("/", (req,res) => {
...
//endpoint menghapus data pelanggaran berdasarkan id_pelanggaran
